...
Ravencoin.prototype._initCaches = function() {
  ...
  this.addressRestrictions = LRU(5000);
  this.globalRestrictions = LRU(5000);
...
Ravencoin.prototype.getAPIMethods = function() {
  var methods = [
    ...
    ['listGlobalRestrictions', this, this.listGlobalRestrictions, 0],
    ...
    ['listAddressRestrictions', this, this.listAddressRestrictions, 1],
...
Ravencoin.prototype._resetCaches = function() {
  ...
  this.addressRestrictions.reset();
  this.globalRestrictions.reset();
...
Ravencoin.prototype.listGlobalRestrictions = function(callback) {
  var self = this;
...
Ravencoin.prototype.getVerifierString = function(asset, callback) {
  var self = this;
...
Ravencoin.prototype.listAddressesForTag = function(asset, callback) {
  var self = this;
...
Ravencoin.prototype.checkVerifier = function(verifier, callback) {
  var self = this;
...
Ravencoin.prototype.listTagsForAddress = function(address, callback) {
  var self = this;
...
Ravencoin.prototype.listAddressRestrictions = function(address, callback) {
  var self = this;
